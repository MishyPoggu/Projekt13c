...
export class SternComponent {
  timelineItems = [
    ...
    { time: '1950-60', image: 'assets/stern/stern-flipper.jpg', description: 'Williams és más úttörő chicagói cégek számos új innovációt vezetett be a flipperben, beleértve a többjátékos játékokat, a ponttárcsákat és az egyre kifinomultabb játéktér mechanizmusokat és művészeti csomagokat.' },
    { time: '1970-80', image: 'assets/stern/computerspace.jpg', description: 'Megjelentek az érmével működő videojátékok. Ahogy a coin-op piac fejlődött, más vállalatok felvásárolták a meglévő flippercégeket. 1986-ban, apja halála után Gary Stern segített megalapítani a Data East Pinballt, amelyet aztán a Sega vásárolt meg, és átnevezte Sega Pinballra. Gary ezt követően megvásárolta az üzletet a Segától, és átnevezte Stern Pinball, Inc.-re.' },
    { time: '1990', image: 'assets/stern/williamspinball.jpg', description: 'A flipper népszerűsége tovább nőtt és az iparág a legjobb éveit élte. Stern Pinball és más chicagói producerek, köztük Williams, Bally, Midway és Gottlieb a flipper legikonikusabb címeit készítették.' },
