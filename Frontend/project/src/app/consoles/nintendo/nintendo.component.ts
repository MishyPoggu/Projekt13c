...
export class NintendoComponent {
  timelineItems = [
    { time: '1889–1949', image: 'assets/hanafuda.jpg', description: 'Fusajiro Yamauchi Kiotóban megalapítja a Nintendo Koppai céget, amely kézzel festett hanafuda kártyákat készít. 1902:A Nintendo elkezdi a nyugati típusú játékkártyák gyártását Japánban. 1929:Fusajiro Yamauchi nyugdíjba vonul, és veje, Sekiryo Kaneda (később Yamauchi) veszi át a vezetést. 1947:Létrejön a Nintendo Playing Card Co. Ltd. néven egy új leányvállalat a kártyák gyártására és forgalmazására.' },
    { time: '1959', image: 'assets/disneyplayingcards.jpg', description: 'A Nintendo licencszerződést köt a Disneyvel, és karakteres játékkártyákat kezd árusítani. A vállalat nevét Nintendo Co., Ltd.-re változtatja, és új piacokra lép (játékok, szállodaipar, éttermek, taxivállalat). ' },
    { time: '1966-77', image: 'assets/laserclayshootingsystem.jpg', description: 'Kidolgozzák az első elektronikus játékot, az Ultra Handet (feltaláló: Gunpei Yokoi). 1973:Létrehozza az első interaktív fényfegyveres attrakcióját, a Laser Clay Shooting Systemet. A Nintendo szerződést köt a Mittel Games-szel, és bemutatják az első videójáték-rendszerüket, amely a Magnavox Odyssey konzolon alapul. Megjelenik az első saját fejlesztésű játékkonzol, a Color TV-Game sorozat.' },
    { time: '1980–89', image: 'assets/donkey-mario.jpg', description: 'Megjelenik az első Game & Watch kézikonzol, amely LCD-kijelzővel működik. 1981: Shigeru Miyamoto megalkotja Donkey Kongot, amely bemutatja a későbbi ikonikus karaktert, Jumpmant (később Mario), majd Japánban megjelenik a Nintendo Family Computer (Famicom), amely a nyugati piacon Nintendo Entertainment System (NES) néven válik ismertté. 1985: Kiadják a Super Mario Bros.-t, amely forradalmasítja a platformjátékokat. 1989:Megjelenik a Game Boy, amely a kézikonzolok piacának meghatározó szereplője lesz.' },
    { time: '1990-99', image: 'assets/pokemonredandblue.jpg', description: 'Japánban debütál a Super Famicom (Super Nintendo Entertainment System, SNES). 1991: Az SNES megjelenik az Egyesült Államokban, és elindul a Sega vs. Nintendo háború. 1996: A Nintendo 64 (N64) piacra kerül, és vele együtt a Super Mario 64, amely új alapokra helyezi a 3D-s platformjátékokat. 1998: Megjelenik a Game Boy Color, valamint az egyik legsikeresebb játék, a Pokémon Red/Blue.' },
