...
export class PlaystationComponent {
  timelineItems = [
    ...
    { time: '2004', image: 'assets/ps/psp.jpg', description: 'A PlayStation Portable (PSP) egy kézi játékkonzol. Először 2004. december 12-én adták ki Japánban. A legerősebb rendszerű hordozható konzol volt,első igazi vetélytársa a Nintendo kézikonzoljainak. A PSP fejlett grafikus képességei népszerű,szórakoztató eszközzé tették, amely PlayStation 2 és PlayStation 3 konzolokhoz csatlakoztatható,ezenfelül pedig bármilyen USB interfésszel rendelkező számítógéphez is csatlakoztatható. A PSP-t pozitívan fogadták a kritikusok, és tízéves élettartama alatt több mint 80 millió darabot adtak el belőle.' },
